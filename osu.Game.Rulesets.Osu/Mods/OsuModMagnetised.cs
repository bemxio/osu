...
namespace osu.Game.Rulesets.Osu.Mods
{
    public class OsuModMagnetised : Mod, IUpdatableByPlayfield, IApplicableToDrawableRuleset<OsuHitObject>
    {
        ...
        public override Type[] IncompatibleMods => new[] { typeof(OsuModAutopilot), typeof(OsuModWiggle), typeof(OsuModTransform), typeof(ModAutoplay), typeof(OsuModRelax), typeof(OsuModAlternativeRelax), typeof(OsuModRepel), typeof(OsuModBubbles), typeof(OsuModDepth) };
